  ...
  return (
    <div className="hero-section">
      ...
      <div className='hero-subtitle'>
        <p>A beginner-friendly game jam for high schoolers, happening in Rwamagana, where <span className='date'>artists</span>,<span className='date'>musicians</span> , and <span className='date'></span> come together to build apps and games. <span className='date'>NOVEMBER 23-24 2024</span></p>
      </div>
